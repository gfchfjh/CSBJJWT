...
| 场景 | 延迟 | 吞吐量 | 成功率 |
|-----|-----|--------|--------|
| 纯文本消息 | 50-200ms | 60条/分 | 99.5% |
| 图片消息（直传） | 200-500ms | 30条/分 | 98% |
| 图片消息（图床） | 300-800ms | 25条/分 | 99% |
| 并发50条/秒 | 200-500ms | 3000条/时 | 97% |
