...
| 教程 | 描述 | 难度 | 阅读时长 |
|------|------|------|---------|
| [01-快速入门](docs/tutorials/01-快速入门指南.md) | 5分钟快速上手 | 简单 | 5分钟 |
| [02-Cookie获取](docs/tutorials/02-Cookie获取详细教程.md) | Cookie获取详细步骤 | 中等 | 10分钟 |
| [03-Discord配置](docs/tutorials/03-Discord配置教程.md) | Discord Bot配置 | 中等 | 12分钟 |
| [04-Telegram配置](docs/tutorials/04-Telegram配置教程.md) | Telegram Bot配置 | 中等 | 12分钟 |
| [05-飞书配置](docs/tutorials/05-飞书配置教程.md) | 飞书Bot配置 | 中等 | 12分钟 |
