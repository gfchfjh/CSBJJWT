...
v1.15.0版本完成了核心改进，实现了：

- ✅ **真正的一键安装**：Chromium/Redis自动集成
- ✅ **Telegram配置超简化**：自动获取Chat ID
- ✅ **安全机制完善**：图床Token过期和访问控制
- ✅ **用户引导优化**：配置向导更清晰
...
| 平台 | v1.15.0 大小 | 说明 |
|------|-------------|------|
| Windows | ~150 MB | 包含所有必要组件 |
| Linux | ~150 MB | 包含所有必要组件 |
| macOS | 开发中 | 即将发布 |

**包含内容**：
- Chromium下载脚本（首次启动自动下载~150MB）
- Redis二进制文件
- 自动化脚本和工具
