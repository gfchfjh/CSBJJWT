...
> 🎉 **v16.0.0 深度优化版** - Electron桌面应用 · 双视图映射 · 智能历史同步 · 视频教程中心
...
#### 教程列表
1. **快速入门指南** - 5分钟上手（⭐ 入门）
2. **Cookie获取详细教程** - 3种方法（⭐ 入门）
3. **Discord Webhook配置** - 2分钟搞定（⭐ 入门）
4. **Telegram Bot配置教程** - 完整演示（⭐⭐ 简单）
5. **飞书自建应用配置** - 详细步骤（⭐⭐ 简单）
6. **智能映射功能详解** - 效率提升500%（⭐⭐⭐ 中等）
7. **过滤规则使用技巧** - 精准转发（⭐⭐ 简单）
8. **常见问题排查指南** - 自助解决（⭐⭐⭐ 中等）
9. **Chrome扩展使用教程** - 3秒导出Cookie（⭐ 入门）
10. **高级功能完整演示** - 解锁所有特性（⭐⭐⭐⭐ 困难）
