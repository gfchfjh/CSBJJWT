...
**最新版本：** v15.0.0 傻瓜式应用版（深度优化完成）  
**最后更新：** 2025-10-29  
**新增工具**: 统一打包脚本 build_all.py | Redis打包工具 | 安装程序生成器

---

## 🆕 v15.0.0 统一打包工具链

**全新的自动化打包系统！** 一键生成所有平台的安装包。

### 📖 核心文档

- [OPTIMIZATION_SUMMARY.md](../OPTIMIZATION_SUMMARY.md) - 优化总结报告
- [RELEASE_NOTES_v15.md](../RELEASE_NOTES_v15.md) - 版本发布说明

### 🔧 v15.0.0 新增工具

| 工具 | 说明 | 代码行数 |
|------|------|---------|
| `scripts/build_all.py` | 统一打包主脚本（支持Windows/macOS/Linux） | 420行 |
| `scripts/package_redis.py` | Redis自动下载和打包工具 | 162行 |
| `scripts/create_installer.py` | 安装程序生成器（NSIS/AppImage/DMG） | 171行 |
...
# [2/6] 下载Redis
# [3/6] 下载Chromium
# [4/6] 打包后端（PyInstaller）
# [5/6] 打包前端（Electron Builder）
# [6/6] 创建安装包

# 输出:
# dist/KOOK-Forwarder-v15.0.0-Windows-x64.zip
# dist/KOOK-Forwarder-v15.0.0-Linux-x64.tar.gz
# dist/KOOK-Forwarder-v15.0.0-macOS-x64.tar.gz

# 方式2: 单独打包Redis
python scripts/package_redis.py
