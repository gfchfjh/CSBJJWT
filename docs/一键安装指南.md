...
#### Windows用户
```
下载: KookForwarder-Setup-1.14.0.exe (~450MB)
...
#### macOS用户
```
下载: KookForwarder-1.14.0.dmg (~480MB)
...
#### Linux用户
```
下载: KookForwarder-1.14.0.AppImage (~420MB)
...
#### Windows
```
1. 双击 KookForwarder-Setup-1.14.0.exe
