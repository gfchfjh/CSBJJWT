...
### Q: v12.1.0相比v12.0.0有哪些提升？

**A**: **9大核心优化，全面提升易用性、性能、稳定性！**
...
**关键特性**:
- ✅ **50+关键词库**: 中英文智能映射（"公告"→announcement/notice/news）
- ✅ **时间衰减**: 半衰期30天（`exp(-0.693 * days / 30)`）
- ✅ **学习能力**: 记录用户选择（接受/拒绝）
- ✅ **90%+准确度**: 比v12.0.0提升29%
...
**性能对比**:
- 优化前: 0.82ms/条（仅SQLite）
- 优化后: 0.008ms/条（内存缓存）
- 提升: **+100倍**

---

### Q: WebSocket智能重连的指数退避算法是什么？

**A**: **智能延迟+随机抖动，99%重连成功率！**
