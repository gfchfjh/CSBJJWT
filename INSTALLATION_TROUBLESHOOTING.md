...
### 🔧 问题2: globalErrorHandler 错误

**症状**: Console 显示 "Cannot read properties of null (reading 'showErrorDialog')"

**原因**: App.vue 中 globalErrorHandler 未正确初始化

**解决**: 已在 v18.0.2 中修复，更新到最新版本即可

### 🔧 问题3: API 404 错误

**症状**: /api/system/status 返回 404
