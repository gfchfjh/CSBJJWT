# 🚀 KOOK消息转发系统 - 3分钟快速开始（v1.16.0）

> **最快上手指南** - 从下载到使用，只需3分钟！
> 
> **v1.16.0新特性**：浏览器扩展一键导入 + 3步配置向导 + 环境自动检查 + 性能提升30%
...
启动应用后，会自动打开**3步配置向导**（v1.16.0简化）：

### 步骤1: 欢迎页（5秒）

**🆕 v1.16.0新增**：现在可以"跳过向导"，直接进入主界面！
...
```
1. 安装Chrome扩展（见 chrome-extension/README.md）
2. 在浏览器登录 https://www.kookapp.cn
3. 点击扩展图标
4. 点击"发送到应用"按钮
5. ✅ 完成！Cookie自动导入
...
**配置时间**：30秒！  
**UI增强**：可视化向导更友好！  
**组件位置**：`frontend/src/components/TelegramChatDetector.vue`
