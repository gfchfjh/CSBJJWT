...
// import Advanced from '../views/Advanced.vue'  // 文件不存在，已注释
import Selectors from '../views/Selectors.vue'
import Help from '../views/Help.vue'
// import Wizard from '../views/Wizard.vue'  // 文件缺失
// import WizardQuick3Steps from '../views/WizardQuick3Steps.vue'  // 文件缺失
// import WizardUltimate3Steps from '../views/WizardUltimate3Steps.vue'  // 文件缺失
// import WizardUnified from '../views/WizardUnified.vue'  // 文件缺失
import WizardSimple3Steps from '../views/WizardSimple3Steps.vue'  // ✅ P0-1新增：真正的3步向导
// import QuickSetup from '../views/QuickSetup.vue'  // 文件缺失
// import Login from '../views/Login.vue'  // 文件缺失

const routes = [
  // Login removed - file missing
  // {
  //   path: '/login',
  //   name: 'Login',
  //   component: Login,
  ...
  // Removed missing wizard variants
  // {
  //   path: '/wizard-advanced',
  //   name: 'WizardAdvanced',
  //   component: WizardUnified,
  ...
  // },
  {
    ...
    children: [
      ...
      // Advanced page removed - component file missing
      // {
      //   path: '/advanced',
      //   name: 'Advanced',
      //   component: Advanced,
